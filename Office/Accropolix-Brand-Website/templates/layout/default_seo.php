...
<head>
    ...
    <!-- <title>Global Management Consulting Firm | Business Success Strategy</title> -->
    ...
    <!-- <meta name=" title" content="Global Management Consulting Firm | Business Success Strategy"> -->
    <!-- <meta name="description" content="Acropolix delivers global management consulting and strategy planning services that empower businesses to tackle challenges and fulfill their goals."> -->
    ...
    <!-- <meta property="og:description" content="Acropolix delivers global management consulting and strategy planning services that empower businesses to tackle challenges and fulfill their goals." /> -->
...
<body>
    ...
    <?php echo $this->element('header_seo') ?>
    <main>
        <?php echo $this->fetch('content') ?>
    </main>
    <?php echo $this->element('footer_seo') ?>
