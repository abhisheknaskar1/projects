...
<section class="hero-slider inner-hero upd-service-hero py-0">
    <div class="container">
        <div class="text-left text-compile text-white">
            <h2 class="mb-4">Marketing Automation</h2>
            <h4>Automation, by people, for people and business </h4>
        </div>
    </div>
</section>
<!-- <section id="" class="service-market-about about mt-5 ">
    <div class="container-fluid">

        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 video-box d-flex justify-content-center align-items-stretch position-relative">
                <a href="https://www.youtube.com/watch?v=6gzMRS4-tUY" class="glightbox play-btn mb-4"></a>
            </div>
        </div>
    </div>
</section> -->
                        ...
                        <div class="blog-multiple-column d-flex w-100 flex-column">
                            <div class="blog-multiple-contentbox">
                                <div class="yt-players text-center ">
                                    <iframe width="100%" height="500" src="https://www.youtube.com/embed/6gzMRS4-tUY?si=LT9DLqYe-KcYVPbb&autoplay=0&mute=1&rel=0&loop=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section>
    <div class="container">
        <div class="section__midline-heading">
            <h3 class="">Automation with Human Touch</h3>
        </div>
        <div class="row">
            <div class="col-lg-3">
                <div class="service-automation-ic">
                    <div class="service-automation-ic-content">
                        <img src="img/service/marketing-automation-icon/ic-1.png" width="80px" class="mb-4">
                        <div class="service-automation-ic-text text-compile">
                            <h4 class="mb-3">Sales & Marketing Automation</h4>
                            <p class="mb-4">Deliver automated personalized customer experience at scale</p>
                        </div>
            ...
            <div class="col-lg-3">
                <div class="service-automation-ic">
                    <div class="service-automation-ic-content">
                        <img src="img/service/marketing-automation-icon/ic-2.png" width="80px" class="mb-4">
                        <div class="service-automation-ic-text text-compile">
                            <h4 class="mb-3">Operational Automation</h4>
                            <p class="mb-4">Eliminate Bottlenecks, Accelerate Growth</p>
                        </div>
            ...
            <div class="col-lg-3">
                <div class="service-automation-ic">
                    <div class="service-automation-ic-content">
                        <img src="img/service/marketing-automation-icon/ic-3.png" width="80px" class="mb-4">
                        <div class="service-automation-ic-text text-compile">
                            <h4 class="mb-3">IT Automation</h4>
                            <p class="mb-4">Automate software deployment, infrastructure management, and routine maintenance tasks</p>
                        </div>
            ...
            <div class="col-lg-3">
                <div class="service-automation-ic">
                    <div class="service-automation-ic-content">
                        <img src="img/service/marketing-automation-icon/ic-4.png" width="80px" class="mb-4">
                        <div class="service-automation-ic-text text-compile">
                            <h4 class="mb-3">AI Consulting</h4>
                            <p class="mb-4">Harness artificial intelligence around with human in centre</p>
                        </div>
...
<section class="">
    <div class="container">
        ...
        <div class="row d-flex align-items-center justify-content-center mt-5">
            <div class="col-lg-8 text-center">
                <p class="font-weight-bold">As Per IBM, 2024 CEO Study,
                    64% of top leaders say succeeding with AI will depend more on people’s adoption than the technology itself.
                </p>
                <p class="font-weight-bold">Is your organization Ready?</p>

                <a href="customer-home.html" class="btn ind-btn"> Find out now
    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center mt-5">
            <div class="col-lg-8 text-center text-compile text-white">
                <h3>Humanize Automation to drive real business value</h3>
            </div>
        </div>
        <div class="row d-flex align-items-center justify-content-center mt-5">
            <div class="col-lg-8 text-center">
