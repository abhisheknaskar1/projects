...
<footer class="footer">
            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <!-- <div class="col-sm-5 mb-4">
                                <div class="mb-3">
                                    <a href="#">
                                        <img src="img/logo-footer.svg" width="200" alt="">
                                    </a>
                                </div>
                    ...
                    <div class="col-sm-3">
                        <h5 class="headin5_amrc text-white pt2">Quick links</h5>
                        <ul class="footer_ul_amrc">
                            <!-- <li><a href="/">Home</a></li> -->
                            <!-- <li><a href="/pages/features">About</a></li>
                                    <li><a href="/pages/startup-support">Services</a></li> -->
                    ...
                    <!-- <div class="col-lg-9">
                        <h5 class="headin5_amrc text-white pt2 ">Find us</h5>
                        <div class="row">
                            <div class="col-lg-4">
                                <p class="mb-4">
    ...
    <div class="container pt-3">
        <p class="text-center">Copyright @2023 | <a href="#">Disha Communication</a></p>
    </div>
</footer>
