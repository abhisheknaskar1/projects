<template>
    ...
    <header id="header" class="header fixed-top header-data-top" data-scrollto-offset="0">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <a class="btn-getstarted scrollto" href="#" @click="openRequestCallBackModal">Request a
                Call Back
            </a>
        </div>
    </header>
                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered  apartment-table tab-content" v-else>
                                ...
                                <tbody>
                                    <template v-for="sector in property.sectors">
                                        <template v-if="!typeEqualToUnknown">
                                            <template v-for="(unit) in sector.units" :key="unit.id">
                                                ...
                                                <td class="text-right" align="right">
                                                    <a href="#" class="btn btn-data price-btn" data-bs-toggle="modal"
                                                       data-bs-target="#exampleModal" @click="openRequestCallBackModal">
                                                        Check Price
                                                    </a>
                                                </td>
                                                </tr>
...
const typeEqualToUnknown = computed( () => {
    return props.property.sectors.some(sector =>
        sector.units.some(unit =>
            unit.property_unit_type && unit.property_unit_type.title === 'unknown',
        )
    );
});
