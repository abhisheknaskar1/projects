...
$(function(){
   $("#card-number").on("keyup", function(){
       let $dropdown = $(this).parents("div.row").eq(0).find(".dropdown").eq(0);
       $dropdown.dropdown("clear");
       if ( $(this).val() ) {
           let cardType = creditCardType($(this).val());
           if ( cardType ) {
               let cardTypeString = cardType[0].type.charAt(0).toUpperCase() + cardType[0].type.slice(1).toLowerCase();
               $dropdown.dropdown("set selected", cardTypeString);
