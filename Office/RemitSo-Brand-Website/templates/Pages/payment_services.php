            ...
            <div class="col-lg-12">
                <div class="blog-column">
                    ...
                    <div class="blog-desc">
                        ...
                        <p>
                           <?php echo __('The revised directive is more stringent than the General Data Protection Regulation (GDPR), considering that it dictates that Payment Service Providers can avail personal data only for the execution of services based on definite consent of the user. However, PSD2 also reflects irrefutable laxity for Account Information Service Providers, with the broad definition of the service giving an opportunity to the provider to circumvent the limitations. Article 5(1)(g) of the directive obligates the payment organisation to provide a descriptive account of the process used to limit access to sensitive payment data. To address prevalent risks, Articles 66(3)(b) and 67(2)(b) state that the payment service providers are obliged to ensure that personal security credentials are not accessible to external parties barring the consent of the user and the issuer. ')?>
                        </p>
                        <p>
                           <?php echo __("By implementing such safeguards and opening up the payment processes, PSD2 attempts to restore the payment order's integrity and provide confidence in the payments ecosystem. It has made consumers feel safe in the digital financial realm where online frauds and scams are a significant threat.")?>
                        </p>
                        <h4 class="font-weight-bold mt-4 mb-3">
                            <?php echo __('RemitSo Software and its capabilities')?>
                        </h4>
                        <p><?php echo __('RemitSo is a remittance software for international money transfer operators, that can help you start-up or expand your international remittance business. Our research team keeps updated with the latest trends and compliance directives and keeps you and customers safe. To know more about who we are and what we do, please connect with us by clicking on this link. ')?></p>
                    </div>
                </div>
            </div>
        </div><!--//row-->
