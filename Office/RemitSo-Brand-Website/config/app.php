...
return [
     ...
     * - imageBaseUrl - Web path to the public img directory under webroot.
    ...
    /*
     * Apply timestamps with the last modified time to static assets (js, css, img).
    ...
    'EmailTransport' => [
        ...
        'smtp' => [
            ...
            'host' => 'smtp.remitall.co.uk',
            'port' => 587,
            'timeout' => 30,
            'username' => 'no-reply@stablebank.co.uk',
            'password' => "`b<'tNdm!A3>_N/Q",
            'client' => null,
            'tls' => true
        ]
    ],
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => 'no-reply@stablebank.co.uk',
            /*
    ...
    // --------------------------G Captcha---------------------------------------
    'recaptcha' => [
        'site_key' => '6LcdkYIqAAAAAAqwdHqL9pFR5arMX4XSnZDmi5D8',
        'secret_key' => '6LcdkYIqAAAAAIXGA_g2_jTKA-Q_1mQFfa0yQ1Tl',
    ],
    // 'recaptcha' => [
    //     'site_key' => '6Lc67HYqAAAAAKNZcWl2uugRW-nRvPabpdB5WiGl',
    //     'secret_key' => '6Lc67HYqAAAAALNmtGqUeaP5pgIhpGdGb80x1dNF',
    // ],
