...
use App\Services\SanctionList\Adapters\Loaders\Seco;
use Illuminate\Console\Command;
use Illuminate\Support\Carbon;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Storage;

class SecoLoad extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:seco-load';
     ...
     * @var string
     */
    protected $description = 'Loading transformed Swiss SECO Sanction List into Database';
    ...
    public function handle(): int
    {
        ...
        $assetPath = 'sanction_lists/output/seco.json';
        if (Storage::disk('local')->exists($assetPath)) {
            ...
            DB::transaction(function () use ($json, $sanctionList) {
                ...
                foreach ($entities as $entity) {
                    Seco::upsert($sanctionList, $entity);
                }
