...
use App\Services\SanctionList\Adapters\Loaders\OfacConsolidated;
use Illuminate\Console\Command;
use Illuminate\Support\Carbon;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Storage;

class OfacConsolidatedLoad extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:ofac-consolidated-load';
     ...
     * @var string
     */
    protected $description = 'Loading transformed OFAC Consolidated List into Database';
    ...
    public function handle(): int
    {
        ...
        $assetPath = 'sanction_lists/output/ofac-consolidated.json';
        if (Storage::disk('local')->exists($assetPath)) {
            ...
            DB::transaction(function () use ($json, $sanctionList) {
                ...
                foreach ($entities as $entity) {
                    OfacConsolidated::upsert($sanctionList, $entity);
                }
