...
use App\Services\SanctionList\Adapters\Transformers\EuFinancialSanction;
use Illuminate\Console\Command;
use Illuminate\Support\Carbon;
use Illuminate\Support\Facades\Storage;
use XMLReader;

class EuFinancialSanctionTransform extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:eu-financial-sanction-transform';
     ...
     * @var string
     */
    protected $description = 'Transform EU Financial Sanction List XML into Loadable JSON';
    ...
    public function handle(): int
    {
        ...
        $assetPath = 'sanction_lists/input/eu-financial-sanctions.xml';
        if (Storage::disk('local')->exists($assetPath)) {
            ...
            if ($reader === false) {
                ...
                $destination = 'sanction_lists/output/eu-financial-sanctions.json';
                ...
                $vendorSanctionList = EuFinancialSanction::transform($sanctionList, $reader);
                $reader->close();
                if (
